...
public class LabirintoBuilderTest {
	...
	@Test
	void testMonolocale() {
		Labirinto l = new LabirintoBuilder().addStanzaIniziale("salotto").addStanzaVincente("salotto").getLabirinto();
	...
	void testBilocale_StanzaInizialeEVincente() {
		Labirinto l = new LabirintoBuilder().addStanzaIniziale("salotto").addStanzaVincente("camera").getLabirinto();
		assertEquals("salotto", l.getStanzaIniziale().getNome());
	...
	void testAddAdiacenza() {
		Labirinto l = new LabirintoBuilder().addStanzaIniziale("salotto").addStanzaVincente("camera")
